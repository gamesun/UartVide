...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sun Sep 08 17:07:30 2013
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.btn_SaveToFileSW = wx.Button(self.pnlSettingBar, wx.ID_ANY, "Save to File >>")
        self.static_line_1 = wx.StaticLine(self.pnlSettingBar, wx.ID_ANY)
        self.pnl_SaveToFile = wx.Panel(self.pnlSettingBar, wx.ID_ANY)
        self.label_6 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "Directory")
        self.text_ctrl_1 = wx.TextCtrl(self.pnl_SaveToFile, wx.ID_ANY, "")
        self.button_2 = wx.Button(self.pnl_SaveToFile, wx.ID_ANY, "...")
        self.label_7 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "File Name")
        self.text_ctrl_2 = wx.TextCtrl(self.pnl_SaveToFile, wx.ID_ANY, "")
        self.label_9 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "Start From")
        self.spin_ctrl_2 = wx.SpinCtrl(self.pnl_SaveToFile, wx.ID_ANY, "", min=0, max=100)
        self.label_10 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "Digit")
        self.spin_ctrl_3 = wx.SpinCtrl(self.pnl_SaveToFile, wx.ID_ANY, "", min=0, max=100)
        self.sizer_12_staticbox = wx.StaticBox(self.pnl_SaveToFile, wx.ID_ANY, "Prefix of File Name")
        self.label_11 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "Start From")
        self.spin_ctrl_4 = wx.SpinCtrl(self.pnl_SaveToFile, wx.ID_ANY, "", min=0, max=100)
        self.label_12 = wx.StaticText(self.pnl_SaveToFile, wx.ID_ANY, "Digit")
        self.spin_ctrl_5 = wx.SpinCtrl(self.pnl_SaveToFile, wx.ID_ANY, "", min=0, max=100)
        self.sizer_13_staticbox = wx.StaticBox(self.pnl_SaveToFile, wx.ID_ANY, "Suffix of File Name")
    ...
    def __do_layout(self):
        ...
        sizer_7.Add(self.btn_SaveToFileSW, 0, wx.LEFT | wx.RIGHT | wx.EXPAND, 5)
        sizer_7.Add(self.static_line_1, 1, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        self.pnl_SaveToFile.SetSizer(sizer_11)
        sizer_8.Add(self.pnl_SaveToFile, 1, wx.EXPAND, 0)
