...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Fri Nov 01 00:41:07 2013
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.chkColW = wx.CheckBox(self.pnlSettingBar, wx.ID_ANY, "Columns Width")
        self.txtctlColW = wx.TextCtrl(self.pnlSettingBar, wx.ID_ANY, "", style=wx.TE_CENTRE)
        self.btnSetColW = wx.Button(self.pnlSettingBar, wx.ID_ANY, "Set Col W")
    ...
    def __do_layout(self):
        ...
        sizer_8.Add(self.static_line_1, 0, wx.TOP | wx.BOTTOM | wx.EXPAND, 8)
        sizer_13.Add(self.chkColW, 1, wx.ALL, 2)
        sizer_13.Add(self.txtctlColW, 0, 0, 0)
        sizer_8.Add(sizer_13, 1, wx.EXPAND, 0)
        sizer_8.Add(self.btnSetColW, 0, wx.ALL | wx.ALIGN_RIGHT, 2)
