...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Wed Oct 30 23:11:33 2013
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.label_6 = wx.StaticText(self.pnlSettingBar, wx.ID_ANY, "Head Data")
        self.txtctlYSHeadData = wx.TextCtrl(self.pnlSettingBar, wx.ID_ANY, "")
        self.label_7 = wx.StaticText(self.pnlSettingBar, wx.ID_ANY, "Address")
        self.txtctlYSAddress = wx.TextCtrl(self.pnlSettingBar, wx.ID_ANY, "")
        self.label_8 = wx.StaticText(self.pnlSettingBar, wx.ID_ANY, "Data")
        self.txtctlYSData = wx.TextCtrl(self.pnlSettingBar, wx.ID_ANY, "")
        self.btnYSWrite = wx.Button(self.pnlSettingBar, wx.ID_ANY, "Write")
    ...
    def __do_layout(self):
        ...
        sizer_9.Add(self.label_6, 1, 0, 0)
        sizer_9.Add(self.txtctlYSHeadData, 0, 0, 0)
        sizer_8.Add(sizer_9, 0, wx.ALL | wx.EXPAND, 1)
        sizer_10.Add(self.label_7, 1, 0, 0)
        sizer_10.Add(self.txtctlYSAddress, 0, 0, 0)
        sizer_8.Add(sizer_10, 0, wx.ALL | wx.EXPAND, 1)
        sizer_11.Add(self.label_8, 1, 0, 0)
        sizer_11.Add(self.txtctlYSData, 0, 0, 0)
        sizer_8.Add(sizer_11, 0, wx.ALL | wx.EXPAND, 1)
        sizer_8.Add(self.btnYSWrite, 0, wx.ALL | wx.ALIGN_RIGHT, 1)
        sizer_7.Add(sizer_8, 1, wx.EXPAND, 0)
        sizer_3.Add(sizer_7, 0, wx.ALL | wx.EXPAND, 2)
