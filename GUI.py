...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.7 (standalone edition) on Sun Jul 07 17:29:18 2013
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.chiocePort = wx.Choice(self.pnlSettingBar, wx.ID_ANY, choices=[])
        ...
        self.radio_box_1 = wx.RadioBox(self.pnlSettingBar, wx.ID_ANY, "HandShake", choices=["None", "RTS/CTS", "DSR/DTR", "Xon/Xoff"], majorDimension=2, style=wx.RA_SPECIFY_ROWS)
        self.btnOpenPort = wx.ToggleButton(self.pnlSettingBar, wx.ID_ANY, "Open")
        self.window_1_pane_2 = wx.Panel(self.SplitterWindow, wx.ID_ANY)
        self.txtctlMain = wx.TextCtrl(self.window_1_pane_2, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.HSCROLL | wx.TE_RICH | wx.TE_RICH2 | wx.TE_LINEWRAP | wx.TE_WORDWRAP | wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        self.SplitterWindow.SplitVertically(self.window_1_pane_1, self.window_1_pane_2, 160)
